 ...
 * 
 * <p>
 * Uses pattern matching and regular expressions to extract the list of
 * {@link SearchCriteria} from the incoming query.
 * </p>
 *
 * @author Payman Salek
 * 
...
public class SpecificationBuilder<T> {
    ...
    private SpecificationBuilder<T> with(String key, String operation,
                                         Object value) {
    ...
    public Specification<T> build() {
        ...
        List<Specification<T>> specs = params.stream()
                .map(EntitySpecification<T>::new).collect(Collectors.toList());
